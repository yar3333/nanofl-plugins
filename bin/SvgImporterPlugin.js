...
svgimport.SvgPathExporter.prototype = {
	...
	,'export': function() {
		...
		while(_g < _g1.length) {
			...
			console.log("edgesToCreatePolygons = " + Std.string(edgesToCreatePolygons));
			console.log("fill = " + Std.string(pf.polygon.fill));
			console.log("pf.fillRuleEvenOdd = " + (pf.fillRuleEvenOdd == null?"null":"" + pf.fillRuleEvenOdd));
