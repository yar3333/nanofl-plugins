...
var BlenderLoaderPlugin = function() {
	this.properties = [{ type : "info", label : "This plugin automatically convert *.blend in your library into *.json (supported by NanoFL)." + " Ensure you have <a href='http://blender.org/'>Blender</a>" + " with <a href='https://github.com/mrdoob/three.js/tree/master/utils/exporters/blender'>ThreeJS Blender Export addon</a> installed."},{ type : "string", name : "blenderPath", label : "Path to the blender.exe", description : "Leave blank to autodetect", defaultValue : ""}];
