...
QuatizeColorsFilterPlugin.__interfaces__ = [models.client.plugins.IFilterPlugin];
QuatizeColorsFilterPlugin.main = function() {
	models.common.Plugins.registerFilter(new QuatizeColorsFilterPlugin());
};
