...
declare module models.common
{
	...
	export class Frame
	{
		...
		keyFrame : models.common.KeyFrame;
		subIndex : number;
		getTweenedElements() : models.common.TweenedElement[];
	}
...
declare module models.common.geom
{
	...
	export class PointTools
	{
		...
		static getDistP(a:models.common.geom.Point, b:models.common.geom.Point) : number;
		static getSqrDistP(a:models.common.geom.Point, b:models.common.geom.Point) : number;
