 ...
 */
@:native("THREE.Points") extern class Points extends js.three.Object3D
{
	/**
	 * @param geometry An instance of Geometry.
	 * @param material An instance of Material (optional).
	 */
	function new(geometry:haxe.extern.EitherType<js.three.Geometry, js.three.BufferGeometry>, ?material:haxe.extern.EitherType<js.three.PointsMaterial, js.three.ShaderMaterial>) : Void;
	/**
	 * An instance of Geometry, where each vertex designates the position of a particle in the system.
	 */
	var geometry : js.three.Geometry;
	/**
