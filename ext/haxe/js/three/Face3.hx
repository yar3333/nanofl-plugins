...
@:native("THREE.Face3") extern class Face3
{
	...
	function new(a:Int, b:Int, c:Int, ?normal:js.three.Vector3, ?color:js.three.Color, ?materialIndex:Int) : Void;
	/**
	 * Vertex A index.
	 */
	var a : Int;
	 ...
	 */
	var vertexNormals : Array<js.three.Vector3>;
	/**
	 * Face color.
	 */
