...
@:native("THREE.CanvasRenderer") extern class CanvasRenderer implements js.three.Renderer
{
	function new(?parameters:js.three.CanvasRendererParameters) : Void;
	var domElement : js.html.CanvasElement;
	var autoClear : Bool;
	var sortObjects : Bool;
	var sortElements : Bool;
	var info : { var render : { var faces : Int; var vertices : Int; }; };
	...
	function setClearColor(color:js.three.Color, ?opacity:Float) : Void;
