...
extern interface ILoaderPlugin
{
	 ...
	 */
	function load(api:nanofl.ide.NanoApi, params:Dynamic, baseDir:String, files:Map<String, nanofl.ide.CachedFile>) : Array<nanofl.engine.libraryitems.LibraryItem>;
}