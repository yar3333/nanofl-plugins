...
extern class ServerApiTools
{
	...
	static function publishDocument(fileApi:nanofl.engine.FileApi, path:String, properties:nanofl.engine.DocumentProperties, library:nanofl.engine.Library, textureAtlases:Map<String, nanofl.ide.textureatlas.TextureAtlas>, publishSettings:Map<String, Dynamic>) : Bool;
