...
extern class ServerApiTools
{
	...
	static function publishDocument(fileApi:nanofl.engine.FileApi, path:String, originalProperties:nanofl.engine.DocumentProperties, originalLibrary:nanofl.engine.Library, textureAtlases:Map<String, nanofl.ide.textureatlas.TextureAtlas>) : { var message : String; var success : Bool; };
