...
typedef IPlugins =
{
	...
	function exportLibraryItem(pluginName:String, ?destFilePath:String, ?callb:Bool -> Void) : Void;
	function importDocument(pluginName:String, ?srcFilePath:String, ?callb:nanofl.ide.Document -> Void) : Void;
	function importLibraryItem(pluginName:String, ?srcFilePath:String, ?callb:nanofl.engine.libraryitems.LibraryItem -> Void) : Void;
