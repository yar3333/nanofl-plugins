 ...
 */
extern class SpriteContainer extends createjs.Container
{
	function new(?spriteSheet:createjs.SpriteSheet) : Void;
	/**
	 ...
	 */
	override function addChild(child:createjs.DisplayObject) : createjs.DisplayObject;
	/**
	 ...
	 */
	override function addChildAt(child:createjs.DisplayObject, index:Int) : createjs.DisplayObject;
	/**
