...
extern class AbstractSoundInstance extends createjs.EventDispatcher
{
	 ...
	 */
	function play(?interrupt:Dynamic, ?delay:Float, ?offset:Float, ?loop:Float, ?volume:Float, ?pan:Float) : createjs.AbstractSoundInstance;
	/**
	 ...
	 *     myInstance.stop();
	 */
	function stop() : createjs.AbstractSoundInstance;
	/**
	 ...
	 */
	function setPaused(value:Bool) : createjs.AbstractSoundInstance;
	/**
	 ...
	 */
	function setVolume(value:Float) : createjs.AbstractSoundInstance;
	/**
	 * NOTE {{#crossLink "AbstractSoundInstance/volume:property"}}{{/crossLink}} can be accessed directly as a property,
	 ...
	 */
	function setMute(value:Bool) : createjs.AbstractSoundInstance;
	/**
	 * NOTE {{#crossLink "AbstractSoundInstance/muted:property"}}{{/crossLink}} can be accessed directly as a property,
	 ...
	 */
	function setPan(value:Float) : createjs.AbstractSoundInstance;
	/**
	 * NOTE {{#crossLink "AbstractSoundInstance/pan:property"}}{{/crossLink}} can be accessed directly as a property,
	 * getPan remains to allow support for IE8 with FlashAudioPlugin.
	 *
	 ...
	 */
	function setPosition(value:Float) : createjs.AbstractSoundInstance;
	/**
	 ...
	 */
	function setDuration(value:Float) : createjs.AbstractSoundInstance;
	/**
	 ...
	 */
	function setPlaybackResource(value:Dynamic) : createjs.AbstractSoundInstance;
	/**
	 * NOTE {{#crossLink "AbstractSoundInstance/playbackResource:property"}}{{/crossLink}} can be accessed directly as a property,
