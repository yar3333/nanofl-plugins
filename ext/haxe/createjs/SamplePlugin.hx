...
extern class SamplePlugin
{
	 ...
	 */
	function getPreloadHandlers() : Dynamic;
	/**
	 ...
	 */
	function preloadHandler(loadItem:Dynamic, queue:createjs.LoadQueue) : Dynamic;
	/**
	 ...
	 */
	function fileLoadHandler(event:createjs.Event) : Void;
}