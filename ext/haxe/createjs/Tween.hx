...
extern class Tween extends createjs.EventDispatcher
{
	 ...
	 */
	function wait(duration:Float, passive:Bool) : createjs.Tween;
	/**
	 * Queues a tween from the current values to the target properties. Set duration to 0 to jump to these value.
	 * Numeric properties will be tweened from their current value in the tween to the target value. Non-numeric
	 * properties will be set at the end of the specified duration.
	 */
	function to(props:Dynamic, ?duration:Float, ?ease:Dynamic) : createjs.Tween;
	/**
	 * Queues an action to call the specified function.
	 */
	function call(callback:Dynamic, ?params:Array<Dynamic>, ?scope:Dynamic) : createjs.Tween;
	/**
	 * Queues an action to set the specified props on the specified target. If target is null, it will use this tween's
	 * target.
	 */
	function set(props:Dynamic, ?target:Dynamic) : createjs.Tween;
	/**
	 * Queues an action to to play (unpause) the specified tween. This enables you to sequence multiple tweens.
	 */
	function play(tween:createjs.Tween) : createjs.Tween;
	/**
	 * Queues an action to to pause the specified tween.
	 */
	function pause(tween:createjs.Tween) : createjs.Tween;
	/**
	 ...
	 */
	function setPaused(value:Bool) : createjs.Tween;
	/**
	 ...
	 */
	static function get(target:Dynamic, ?props:Dynamic, ?pluginData:Dynamic, ?override_:Bool) : createjs.Tween;
	/**
