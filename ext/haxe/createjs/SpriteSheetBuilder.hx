...
extern class SpriteSheetBuilder extends createjs.EventDispatcher
{
	 ...
	 */
	function addFrame(source:createjs.DisplayObject, ?sourceRect:createjs.Rectangle, ?scale:Float, ?setupFunction:Dynamic, ?setupData:Dynamic) : Float;
	/**
	 ...
	 */
	function addMovieClip(source:createjs.MovieClip, ?sourceRect:createjs.Rectangle, ?scale:Float, ?setupFunction:Dynamic, ?setupData:Dynamic, ?labelFunction:Dynamic) : Void;
	/**
	 * Builds a SpriteSheet instance based on the current frames.
	 */
	function build() : createjs.SpriteSheet;
	/**
