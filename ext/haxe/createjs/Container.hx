 ...
 *      container.x = 100;
 */
extern class Container extends createjs.DisplayObject
{
	function new() : Void;
	/**
	 ...
	 */
	function addChild(child:createjs.DisplayObject) : createjs.DisplayObject;
	/**
	 ...
	 */
	function addChildAt(child:createjs.DisplayObject, index:Int) : createjs.DisplayObject;
	/**
	 ...
	 */
	function removeChild(child:createjs.DisplayObject) : Bool;
	/**
	 ...
	 */
	function getChildAt(index:Int) : createjs.DisplayObject;
	/**
	 * Returns the child with the specified name.
	 */
	function getChildByName(name:String) : createjs.DisplayObject;
	/**
	 ...
	 */
	function getChildIndex(child:createjs.DisplayObject) : Int;
	/**
	 ...
	 * Container.
	 */
	function swapChildren(child1:createjs.DisplayObject, child2:createjs.DisplayObject) : Void;
	/**
	 * Changes the depth of the specified child. Fails silently if the child is not a child of this container, or the index is out of range.
	 */
	function setChildIndex(child:createjs.DisplayObject, index:Int) : Void;
	/**
	 * Returns true if the specified display object either is this container or is a descendent (child, grandchild, etc)
	 * of this container.
	 */
	function contains(child:createjs.DisplayObject) : Bool;
	/**
	 ...
	 */
	function getObjectsUnderPoint(x:Float, y:Float, ?mode:Int) : Array<createjs.DisplayObject>;
	/**
	 * Similar to {{#crossLink "Container/getObjectsUnderPoint"}}{{/crossLink}}, but returns only the top-most display
	 * object. This runs significantly faster than <code>getObjectsUnderPoint()</code>, but is still potentially an expensive
	 * operation. See {{#crossLink "Container/getObjectsUnderPoint"}}{{/crossLink}} for more information.
	 */
	function getObjectUnderPoint(x:Float, y:Float, ?mode:Int) : createjs.DisplayObject;
	/**
