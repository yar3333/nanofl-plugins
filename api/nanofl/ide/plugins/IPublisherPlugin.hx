...
extern interface IPublisherPlugin
{
	 ...
	 */
	function publish(api:nanofl.ide.NanoApi, params:Dynamic, filePath:String, documentProperties:nanofl.ide.DocumentProperties, library:nanofl.ide.library.Library, files:Array<{ var relPath : String; var baseDir : String; }>) : Void;
}