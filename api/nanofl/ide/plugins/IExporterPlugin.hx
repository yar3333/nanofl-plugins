...
extern interface IExporterPlugin
{
	 ...
	 * @return	Success flag.
	 */
	function exportDocument(api:nanofl.ide.NanoApi, params:Dynamic, srcFilePath:String, destFilePath:String, documentProperties:nanofl.ide.DocumentProperties, library:nanofl.ide.library.Library) : Bool;
}