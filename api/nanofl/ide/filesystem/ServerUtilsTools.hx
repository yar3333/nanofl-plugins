...
extern class ServerUtilsTools
{
	...
	static function saveDocument(api:nanofl.ide.NanoApi, path:String, properties:nanofl.ide.DocumentProperties, library:nanofl.ide.library.Library, textureAtlases:Map<String, nanofl.ide.textureatlas.TextureAtlas>, fileActions:Array<nanofl.ide.filesystem.FileAction>) : { var errorMessage : String; var lastModified : Date; };
	static function publishDocument(fileSystem:nanofl.engine.FileSystem, path:String, properties:nanofl.ide.DocumentProperties, library:nanofl.ide.library.Library, textureAtlases:Map<String, nanofl.ide.textureatlas.TextureAtlas>) : { var message : String; var success : Bool; };
