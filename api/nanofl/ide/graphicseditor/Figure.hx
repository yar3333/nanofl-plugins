...
extern class Figure
{
	function new(editor:nanofl.ide.graphicseditor.Editor, layers:Array<nanofl.ide.graphicseditor.EditorLayer>) : Void;
	...
	function getSelectedElements() : Array<nanofl.ide.graphicseditor.FigureElement>;
