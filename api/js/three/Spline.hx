...
@:native("THREE.Spline") extern class Spline
{
	 ...
	 */
	function new(points:Array<js.three.SplineControlPoint>) : Void;
	var points : Array<js.three.SplineControlPoint>;
	/**
	 ...
	 * @param k point index
	 */
	function getPoint(k:Float) : js.three.SplineControlPoint;
	/**
	 ...
	 */
	function getLength(?nSubDivisions:Float) : { var chunks : Array<Float>; var total : Int; };
	/**
