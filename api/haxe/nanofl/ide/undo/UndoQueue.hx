...
extern class UndoQueue
{
	 ...
	 */
	function beginTransaction(operations:{ @:optional var document : Bool; @:optional var element : nanofl.engine.elements.Element; @:optional var elements : Bool; @:optional var figure : Bool; @:optional var libraryAddItems : Bool; @:optional var libraryChangeItems : Array<String>; @:optional var libraryRemoveItems : Array<String>; @:optional var libraryRenameItems : Array<{ var oldNamePath : String; var newNamePath : String; }>; @:optional var timeline : Bool; @:optional var transformations : Bool; }) : Void;
