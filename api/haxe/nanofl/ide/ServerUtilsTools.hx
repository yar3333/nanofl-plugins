...
{
	static function loadDocument(api:nanofl.ide.NanoApi, path:String, lastModified:Date) : { var lastModified : Date; var library : nanofl.engine.Library; var properties : nanofl.ide.DocumentProperties; };
	static function saveDocument(api:nanofl.ide.NanoApi, path:String, properties:nanofl.ide.DocumentProperties, library:nanofl.engine.Library, textureAtlases:Map<String, nanofl.ide.textureatlas.TextureAtlas>, fileActions:Array<nanofl.ide.FileAction>) : { var generatorError : String; var lastModified : Date; };
	static function publishDocument(api:nanofl.ide.NanoApi, path:String, originalProperties:nanofl.ide.DocumentProperties, originalLibrary:nanofl.engine.Library, textureAtlases:Map<String, nanofl.ide.textureatlas.TextureAtlas>) : { var message : String; var success : Bool; };
