...
extern class Library extends nanofl.engine.Library
{
	...
	override function clone() : nanofl.ide.Library;
	...
	function getOptimized(optimizations:nanofl.ide.PublishOptimizations) : nanofl.ide.Library;
	static var SCENE_NAME_PATH(default, never) : String;
	static function createWithScene(?libraryDir:String, ?elements:Array<nanofl.engine.elements.Element>, ?layerName:String) : nanofl.ide.Library;
}