...
class SVGData extends Group
{
	...
	public function loadGroup (g:Group, inG:Xml, matrix:Matrix, inStyles:Map<String, String>) : Group {
	...
	public function loadPath (inPath:Xml, matrix:Matrix, inStyles:Map<String, String>, inIsRect:Bool, inIsEllipse:Bool, inIsCircle=false) : Path
	{
	...
	public function loadText(inText:Xml, matrix:Matrix, inStyles:Map<String, String>) : Text
	{
