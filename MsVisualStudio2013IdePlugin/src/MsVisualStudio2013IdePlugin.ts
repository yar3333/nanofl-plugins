...
{
    public name = "MS Visual Studio 2013";

	public languages = [ "JavaScript", "TypeScript" ];
	
	public generateFiles(language:string, fileApi:FileApi, filePath:string, documentProperties:DocumentProperties, library:Library) : void
	{
